...
<body>
    ...
    <div class="container" style="margin-top: 20px;">
        <h3 class="text-center"><u>CONTACT FORM</u></h3>
    </div>
<form method="post">
    <div class="container" style="margin-top: 20px; border: 1px solid black; border-radius: 10px;padding:20px; align-items: center;">
        ...
        <div class="form-group row">
          <label for="userid" class="col-sm-2 col-form-label"><strong>ContactId</strong></label>
          <div class="col-sm-10">
            <input type="text" class="form-control"  name="contactid" id="contactid" placeholder="Contactid">
          </div>
        </div>
        <div class="row">
...
include 'connect.php';
              if (isset($_POST['submit'])) {
               ...
               $query = "insert into contact values ($userid,'$name','$email','$phone','$message','$contactid')";
